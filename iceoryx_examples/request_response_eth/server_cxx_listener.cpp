...
constexpr char APP_NAME[] = "iox-cpp-request-response-server-listener-eth";

//! [request callback]
void onRequestReceived(iox::popo::Server<DataBuffer, DataBuffer>* server)
{
    //! [take request]
...
{    
    ...
    iox::popo::Server<DataBuffer, DataBuffer> server({"Example", "Request-Response", "Test"}, options);
    //! [create server]
